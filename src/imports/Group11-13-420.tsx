import svgPaths from "./svg-ems8wf390o";
...
export default function Group() {
  return (
    <div className="relative size-full">
      <div className="absolute flex h-[220.677px] items-center justify-center left-[45.74px] top-0 w-[176.658px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[-9.77deg]">
          <div className="h-[198.95px] relative rounded-[12.376px] w-[144.986px]" data-name="image 3">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[12.376px]">
              <img alt="" className="absolute h-[157.8%] left-0 max-w-none top-0 w-full" src={imgImage3} />
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[219.772px] items-center justify-center left-[186px] top-[7.71px] w-[171.33px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[6.37deg]">
          <div className="h-[204.447px] relative rounded-[9.89px] w-[149.584px]" data-name="image 5">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[9.89px]">
              <img alt="" className="absolute h-[253.25%] left-0 max-w-none top-[-0.25%] w-full" src={imgImage5} />
            </div>
          </div>
        </div>
      </div>
      <div className="absolute h-[187px] left-[10px] rounded-[21.016px] top-[37px] w-[403px]" data-name="image 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[21.016px]">
          <img alt="" className="absolute h-[113.1%] left-[-0.03%] max-w-none top-[0.05%] w-[99.96%]" src={imgImage2} />
        </div>
      </div>

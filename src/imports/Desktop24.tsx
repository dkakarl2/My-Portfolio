import svgPaths from "./svg-rtxie9wte4";
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop - 24">
      <Frame />
      <Frame10 />
      <div className="absolute flex h-[61.185px] items-center justify-center left-[575px] top-[162px] w-[54.548px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[62.2deg]">
          <Group1 />
        </div>
      </div>
      <div className="absolute flex h-[61.185px] items-center justify-center left-[628.01px] top-[714.65px] w-[54.548px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[62.2deg]">
          <Group3 />
        </div>
      </div>
      <div className="absolute flex h-[61.185px] items-center justify-center left-[683px] top-[418.67px] w-[54.548px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[62.2deg]">
          <Group2 />
        </div>
      </div>

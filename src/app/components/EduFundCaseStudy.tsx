        ...
        <div className="lg:hidden w-full flex flex-col items-center pb-32 bg-white px-6">
          ...
          <div className="w-full space-y-16 max-w-md mx-auto">
            ...
            <div className="space-y-6">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">Overview</h2>
              <p className="font-['Manrope'] text-[#484848] text-base leading-relaxed">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-[#D97706]">
                <p className="font-['Manrope'] text-[#484848] text-sm">
                  <strong>My Role:</strong> Led the design of a mobile-first Fixed Deposit investment experience that simplified onboarding, boosted engagement by 30%, and decreased drop-offs by 15%.
                </p>
              </div>
            </div>
            ...
            {/* 3. The Opportunity */}
            <div className="space-y-6">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">The Opportunity</h2>
              <p className="font-['Manrope'] text-[#484848] text-base">
            ...
            <div className="space-y-8">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">Context & Problem</h2>
              <p className="font-['Manrope'] font-bold text-lg text-black">
              ...
              <div className="space-y-6">
                <div className="text-center bg-white border border-gray-100 p-4 rounded-xl shadow-sm">
                  ...
                  <p className="font-['Manrope'] italic text-sm text-[#484848]">Intimidating long KYC processes.</p>
                </div>
                <div className="text-center bg-white border border-gray-100 p-4 rounded-xl shadow-sm">
                  <img src={imgImage116} alt="Solution" className="w-full h-32 object-contain mb-2" />
                  <p className="font-['Manrope'] italic text-sm text-[#484848]">Need for step-by-step guidance.</p>
                </div>
                <div className="text-center bg-white border border-gray-100 p-4 rounded-xl shadow-sm">
                  <img src={imgImage107} alt="Trust" className="w-full h-32 object-contain mb-2" />
                  <p className="font-['Manrope'] italic text-sm text-[#484848]">Building confidence and trust.</p>
                </div>
              </div>
            </div>
            ...
            {/* 5. Research */}
            <div className="space-y-6">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">Research</h2>
              <p className="font-['Manrope'] text-[#484848] text-base">
            ...
            <div className="space-y-6">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">Product Design Strategy</h2>
              <div className="bg-gray-50 p-6 rounded-xl space-y-4">
                <h3 className="font-['Manrope'] font-bold text-black text-lg">Key Design Principles:</h3>
                <div className="space-y-3">
                  <div className="flex gap-3 items-start">
                    <span className="bg-[#D97706] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span>
                    <p className="font-['Manrope'] text-sm text-[#484848]"><strong>Clarity First:</strong> Break down financial jargon into plain language with instant return calculators.</p>
                  </div>
                  <div className="flex gap-3 items-start">
                    <span className="bg-[#D97706] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</span>
                    <p className="font-['Manrope'] text-sm text-[#484848]"><strong>Guided Onboarding:</strong> Split long KYC procedures into digestible, bite-sized steps with clear progress markers.</p>
                  </div>
                  <div className="flex gap-3 items-start">
                    <span className="bg-[#D97706] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</span>
                    <p className="font-['Manrope'] text-sm text-[#484848]"><strong>Trust Signifiers:</strong> Highlight partner credentials (Shriram Finance) and security badges throughout.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">Low-Fidelity Wireframes</h2>
              <p className="font-['Manrope'] text-[#484848] text-base">
                Early structural explorations focused on creating an intuitive flow from plan selection to payment confirmation.
              </p>
            ...
            <div className="space-y-8">
              <h2 className="font-['Manrope'] font-bold text-2xl text-black border-b pb-2">High Fidelity Prototypes</h2>
              <p className="font-['Manrope'] text-[#484848] text-base">
              ...
              <div className="w-full mt-4">
                <p className="font-['Manrope'] font-medium text-black mb-2">Portfolio View</p>
            ...
            <div className="space-y-8">
              <div className="text-center">
                <h3 className="font-['Manrope'] font-bold text-2xl text-black mb-2">Results & Impact</h3>
                <p className="font-['Manrope'] text-[#484848]">The FD integration successfully launched, offering a secure option for parents.</p>
              </div>

              <div className="grid gap-6">
                <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm text-center">
                  <p className="font-['Manrope'] font-medium text-[#5d5d5d] mb-2">Engagement increased by</p>
                  <p className="font-['Manrope'] font-bold text-5xl text-black">30%</p>
                </div>
                <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm text-center">
                  <p className="font-['Manrope'] font-medium text-[#5d5d5d] mb-2">Drop-off reduced by</p>
                  <p className="font-['Manrope'] font-bold text-5xl text-black">15%</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#f9f9f9] p-8 rounded-2xl mb-8">
              <h3 className="font-['Manrope'] font-bold text-xl text-black mb-4">Final Reflection</h3>
              <p className="font-['Manrope'] text-[#484848] text-base leading-relaxed">
            ...
            <div className="pt-8 border-t border-gray-100 w-full text-center">
              <p className="font-['Caveat_Brush'] text-[16px] text-black mb-4 leading-[1.2] font-bold">
                Open to conversation, projects<br />
                and internship roles!
              </p>
              <p className="font-['Caveat_Brush'] text-[#747474] text-[16px] font-bold">
